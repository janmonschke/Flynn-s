...
var halfcarry_add_table = byteTable([ 0, 0x10, 0x10, 0x10, 0, 0, 0, 0x10 ]);
var halfcarry_sub_table = byteTable([ 0, 0, 0x10, 0, 0x10, 0, 0x10, 0x10 ]);
var overflow_add_table = byteTable([ 0, 0, 0, 0x04, 0x04, 0, 0, 0 ]);
var overflow_sub_table = byteTable([ 0, 0x04, 0, 0, 0, 0, 0x04, 0 ]);
var sz53_table = new Uint8Array(256);
var parity_table = new Uint8Array(256);
var sz53p_table = new Uint8Array(256);
var z80 = {
