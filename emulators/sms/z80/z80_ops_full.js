...
function z80_do_opcodes()
{
  while(tstates < event_next_event ) {
    ...
    opcode = readbyte( z80.pc++ ); z80.pc &= 0xffff;
    switch(opcode) {
    case 0x00:
      break;
    case 0x01:
    ...
    case 0x21:
      ...
      break;
    case 0x22:
      { var ldtemp; tstates+=12; ldtemp=readbyte(z80.pc++); z80.pc &= 0xffff; ldtemp|=readbyte(z80.pc++) << 8; z80.pc &= 0xffff; writebyte(ldtemp++,(z80.l)); ldtemp &= 0xffff; writebyte(ldtemp,(z80.h)); break;};
      break;
    case 0x23:
      tstates += 2;
    ...
    case 0x29:
      ...
      break;
    case 0x2a:
      { var ldtemp; tstates+=12; ldtemp=readbyte(z80.pc++); z80.pc &= 0xffff; ldtemp|=readbyte(z80.pc++) << 8; z80.pc &= 0xffff; (z80.l)=readbyte(ldtemp++); ldtemp &= 0xffff; (z80.h)=readbyte(ldtemp); break;};
      break;
    case 0x2b:
      tstates += 2;
      var wordtemp = ((z80.l | (z80.h << 8)) - 1) & 0xffff;
    ...
    case 0x21:
      ...
      break;
    case 0x22:
      { var ldtemp; tstates+=12; ldtemp=readbyte(z80.pc++); z80.pc &= 0xffff; ldtemp|=readbyte(z80.pc++) << 8; z80.pc &= 0xffff; writebyte(ldtemp++,(z80.ixl)); ldtemp &= 0xffff; writebyte(ldtemp,(z80.ixh)); break;};
      break;
    case 0x23:
      tstates += 2;
    ...
    case 0x29:
      ...
      break;
    case 0x2a:
      { var ldtemp; tstates+=12; ldtemp=readbyte(z80.pc++); z80.pc &= 0xffff; ldtemp|=readbyte(z80.pc++) << 8; z80.pc &= 0xffff; (z80.ixl)=readbyte(ldtemp++); ldtemp &= 0xffff; (z80.ixh)=readbyte(ldtemp); break;};
      break;
    case 0x2b:
      tstates += 2;
      var wordtemp = ((z80.ixl | (z80.ixh << 8)) - 1) & 0xffff;
    ...
    case 0x42:
      ...
      break;
    case 0x43:
      { var ldtemp; tstates+=12; ldtemp=readbyte(z80.pc++); z80.pc &= 0xffff; ldtemp|=readbyte(z80.pc++) << 8; z80.pc &= 0xffff; writebyte(ldtemp++,(z80.c)); ldtemp &= 0xffff; writebyte(ldtemp,(z80.b)); break;};
      break;
    case 0x44:
    case 0x4c:
    case 0x54:
    ...
    case 0x4a:
      ...
      break;
    case 0x4b:
      { var ldtemp; tstates+=12; ldtemp=readbyte(z80.pc++); z80.pc &= 0xffff; ldtemp|=readbyte(z80.pc++) << 8; z80.pc &= 0xffff; (z80.c)=readbyte(ldtemp++); ldtemp &= 0xffff; (z80.b)=readbyte(ldtemp); break;};
      break;
    case 0x4f:
      tstates += 1;
      z80.r=z80.r7=z80.a;
    ...
    case 0x52:
      ...
      break;
    case 0x53:
      { var ldtemp; tstates+=12; ldtemp=readbyte(z80.pc++); z80.pc &= 0xffff; ldtemp|=readbyte(z80.pc++) << 8; z80.pc &= 0xffff; writebyte(ldtemp++,(z80.e)); ldtemp &= 0xffff; writebyte(ldtemp,(z80.d)); break;};
      break;
    case 0x56:
    case 0x76:
      z80.im=1;
    ...
    case 0x5a:
      ...
      break;
    case 0x5b:
      { var ldtemp; tstates+=12; ldtemp=readbyte(z80.pc++); z80.pc &= 0xffff; ldtemp|=readbyte(z80.pc++) << 8; z80.pc &= 0xffff; (z80.e)=readbyte(ldtemp++); ldtemp &= 0xffff; (z80.d)=readbyte(ldtemp); break;};
      break;
    case 0x5e:
    case 0x7e:
      z80.im=2;
    ...
    case 0x72:
      ...
      break;
    case 0x73:
      { var ldtemp; tstates+=12; ldtemp=readbyte(z80.pc++); z80.pc &= 0xffff; ldtemp|=readbyte(z80.pc++) << 8; z80.pc &= 0xffff; writebyte(ldtemp++,((z80.sp & 0xff))); ldtemp &= 0xffff; writebyte(ldtemp,((z80.sp >> 8))); break;};
      break;
    case 0x78:
      tstates += 1;
    ...
    case 0x7a:
      ...
      break;
    case 0x7b:
      { var ldtemp; tstates+=12; ldtemp=readbyte(z80.pc++); z80.pc &= 0xffff; ldtemp|=readbyte(z80.pc++) << 8; z80.pc &= 0xffff; var regl = readbyte(ldtemp++); ldtemp &= 0xffff; var regh =readbyte(ldtemp); z80.sp = regl | (regh << 8); break;};
      break;
    case 0xa0:
      {
    var bytetemp=readbyte( (z80.l | (z80.h << 8)) );
    ...
    case 0x21:
      ...
      break;
    case 0x22:
      { var ldtemp; tstates+=12; ldtemp=readbyte(z80.pc++); z80.pc &= 0xffff; ldtemp|=readbyte(z80.pc++) << 8; z80.pc &= 0xffff; writebyte(ldtemp++,(z80.iyl)); ldtemp &= 0xffff; writebyte(ldtemp,(z80.iyh)); break;};
      break;
    case 0x23:
      tstates += 2;
    ...
    case 0x29:
      ...
      break;
    case 0x2a:
      { var ldtemp; tstates+=12; ldtemp=readbyte(z80.pc++); z80.pc &= 0xffff; ldtemp|=readbyte(z80.pc++) << 8; z80.pc &= 0xffff; (z80.iyl)=readbyte(ldtemp++); ldtemp &= 0xffff; (z80.iyh)=readbyte(ldtemp); break;};
      break;
    case 0x2b:
      tstates += 2;
      var wordtemp = ((z80.iyl | (z80.iyh << 8)) - 1) & 0xffff;
